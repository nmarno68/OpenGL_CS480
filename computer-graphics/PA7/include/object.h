...
class Object
{
  public:
    ...
    void SetValues(float o_vel, float r_vel, float o_width, float o_length, float new_scale, float new_tip, float new_x_axis, float new_y_axis);
  ...
  private:
    ...
    float orbit_angle, rotate_angle, orbit_vel, rotate_vel, scale, orbit_width, orbit_length, tip, x_axis, y_axis;
